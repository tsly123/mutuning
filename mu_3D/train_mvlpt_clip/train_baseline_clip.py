...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline_clip = CN()
    cfg.TRAINER.Baseline_clip.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.Baseline_clip.PROJECT_METHOD = 'transformer'  # could be identity / mlp / transformer
    cfg.TRAINER.Baseline_clip.PROJECT_DIM = 128  # if coop/vpt dimension doesnot match, project to vpt/coop
