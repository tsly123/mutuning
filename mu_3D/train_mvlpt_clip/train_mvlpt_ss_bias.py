...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/trainers/mvlpt_ss_bias.py'
    ...
    train_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/train_mvlpt_clip/train_mvlpt_ss_bias.py'
    train_dst = trainer_dir + '/train_mvlpt_ss_bias.py'
