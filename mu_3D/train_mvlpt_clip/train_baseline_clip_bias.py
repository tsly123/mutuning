...
import trainers.baseline_clip_bias
...
import datasets.dermamnist
import datasets.retinamnist
import datasets.patch_camelyon
###################################
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline_clip_bias = CN()
    cfg.TRAINER.Baseline_clip_bias.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.Baseline_clip_bias.PROJECT_METHOD = 'transformer'  # could be identity / mlp / transformer
    cfg.TRAINER.Baseline_clip_bias.PROJECT_DIM = 128  # if coop/vpt dimension doesnot match, project to vpt/coop
...
def main(args):
    ...
    # print('train params requires_grad')
