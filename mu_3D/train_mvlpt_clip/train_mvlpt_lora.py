...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/trainers/mvlpt_lora.py'
    trainer_dst = trainer_dir+'/mvlpt_lora.py'
    ...
    train_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/train_mvlpt_clip/train_mvlpt_lora.py'
    train_dst = trainer_dir + '/train_mvlpt_lora.py'
