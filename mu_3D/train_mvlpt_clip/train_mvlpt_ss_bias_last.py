...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/trainers/mvlpt_ss_bias_last.py'
    trainer_dst = trainer_dir+'/mvlpt_ss_bias_last.py'
    shutil.copyfile(trainer_scr, trainer_dst)

    clip_model_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/clip/model_ss.py'
    ...
    train_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/train_mvlpt_clip/train_mvlpt_ss_bias_last.py'
    train_dst = trainer_dir + '/train_mvlpt_ss_bias_last.py'
    shutil.copyfile(train_scr, train_dst)
