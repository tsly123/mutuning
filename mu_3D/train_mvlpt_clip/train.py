...
# import datasets.fracturemnist3d
import datasets.nodulemnist3d
# import datasets.organmnist3d
# import datasets.synapsemnist3d
...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/trainers/mvlpt.py'
...
def reset_cfg(cfg, args):
    ...
    # if args.is_pretrain:
    #     cfg.IS_PRETRAIN = args.is_pretrain
    #
    # if args.is_progressive:
    #     cfg.IS_PROGRESSIVE = args.is_progressive

    if args.n_prompts is not None:
        cfg.TRAINER.N_PROMPTS = args.n_prompts
...
def extend_cfg(cfg, args):
    ...
    # cfg.TRAINER.MVLPT.PREC = "amp"  # fp16, fp32, amp
...
def main(args):
    ...
    # print('PRINT models')
    # print(trainer.model)
    # print(trainer.model.prompt_learner)
    # print(trainer._models.prompt_learner)

    # trainer.load_clip_to_cpu2(cfg)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--is_progressive", action="store_true")
