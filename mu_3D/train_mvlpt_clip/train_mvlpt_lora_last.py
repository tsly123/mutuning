...
import trainers.mvlpt_lora_last
...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/trainers/mvlpt_lora_last.py'
    trainer_dst = trainer_dir+'/mvlpt_lora_last.py'
    shutil.copyfile(trainer_scr, trainer_dst)

    clip_model_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/clip/model_lora.py'
    ...
    train_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_3D/train_mvlpt_clip/train_mvlpt_lora_last.py'
    train_dst = trainer_dir + '/train_mvlpt_lora_last.py'
