...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.ssf_scale_1, self.ssf_shift_1 = init_ssf_scale_shift(embed_dim, dtype)

        if norm_layer:
            self.ssf_scale_2, self.ssf_shift_2 = init_ssf_scale_shift(embed_dim, dtype)
...
class Mlp(nn.Module):
    ...
    def __init__(
        ...
        self.ssf_scale_1, self.ssf_shift_1 = init_ssf_scale_shift(hidden_features, dtype)
        self.ssf_scale_2, self.ssf_shift_2 = init_ssf_scale_shift(out_features, dtype)
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0.):
        ...
        self.ssf_scale_1, self.ssf_shift_1 = init_ssf_scale_shift(dim * 3, dtype)
        self.ssf_scale_2, self.ssf_shift_2 = init_ssf_scale_shift(dim, dtype)

    def forward(self, x):
        B, N, C = x.shape

        qkv = (ssf_ada(self.qkv(x.to(self.qkv.weight.dtype)), self.ssf_scale_1, self.ssf_shift_1)).reshape(B, N, 3, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.ssf_scale_1, self.ssf_shift_1 = init_ssf_scale_shift(dim, dtype)
        self.ssf_scale_2, self.ssf_shift_2 = init_ssf_scale_shift(dim, dtype)
