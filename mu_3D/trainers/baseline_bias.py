...
def load_clip_to_cpu(cfg):
    ...
    bootstrap_method = "inflation"  # 'centering', 'inflation', cfg.MODEL.BACKBONE.BOOTSTRAP
...
class Baseline_bias_trainer(TrainerX):
    ...
    def build_model(self):
        ...
        for name, param in self.model.named_parameters():
            ...
            if 'visual.conv1' in name or 'visual.positional_embedding' in name or 'visual.scale' in name \
            ...
            # if 'image_encoder' in name and 'attn' in name:
            #     param.requires_grad_(True)
        ...
        self.register_model("baseline_bias_model", self.model.image_encoder, self.optim, self.sched)
    ...
    def load_model(self, directory, epoch=None, name_model=None):
        ...
        for name in names:
            ...
            # set strict=False
            msg = self._models[name].load_state_dict(state_dict, strict=True)
