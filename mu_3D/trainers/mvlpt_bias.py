...
class ImageEncoder(nn.Module):
    def __init__(self, clip_model, mvlpt_model):
        ...
        # print('ImageEncoder width', width)
        ...
        #     ssf_scale, ssf_shift = init_ssf_scale_shift(width, dtype)
        #     self.scale.append(ssf_scale)
        #     self.shift.append(ssf_shift)
        ...
        # self.ssf_scale_8, self.ssf_shift_8 = init_ssf_scale_shift(width, dtype=dtype)
    ...
    def forward(self, x: torch.Tensor, vpt_embeddings=None, vpt_embeddings_deep=None):
        ...
        # x = ssf_ada(x, self.ssf_scale_1, self.ssf_shift_1)  # .to(x.dtype)
...
class MVLPT_bias_trainer(TrainerX):
