...
def load_clip_to_cpu(cfg):
    ...
    depth_chans_3D = cfg.INPUT.SIZE[2]
    print('depth_chans_3D', depth_chans_3D)
    bootstrap_method = "inflation"  # 'centering', 'inflation', 'centering_square, cfg.MODEL.BACKBONE.BOOTSTRAP
...
class MVLPT_lora_last_trainer(TrainerX):
