...
class Baseline_last_trainer(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.Baseline_last.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.Baseline_last.PREC == "fp32" or cfg.TRAINER.Baseline_last.PREC == "amp":
        ...
        if cfg.TRAINER.Baseline_last.PREC == "fp16":
            # print('')
        ...
        for name, param in self.model.named_parameters():
            ...
            # adapt to 3D data
            # set requires_grad_(True) for input layer of VIT image_encoder
        ...
        self.optim = build_optimizer(self.model.image_encoder.head, cfg.OPTIM, param_groups=param_groups)
        self.sched = build_lr_scheduler(self.optim, cfg.OPTIM)
        self.register_model("baseline_last_model", self.model.image_encoder.head, self.optim, self.sched)
        self.scaler = GradScaler() if cfg.TRAINER.Baseline_last.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.Baseline_last.PREC
        if prec == "amp":
            with autocast():
