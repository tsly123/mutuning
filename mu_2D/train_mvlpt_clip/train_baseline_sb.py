...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/baseline_sb.py'
    trainer_dst = trainer_dir+'/baseline_sb.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_baseline_sb.py'
    cfg_dst = trainer_dir + '/train_baseline_sb.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline_sb = CN()
    cfg.TRAINER.Baseline_sb.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.Baseline_sb.PROJECT_METHOD = 'transformer'  # could be identity / mlp / transformer
    cfg.TRAINER.Baseline_sb.PROJECT_DIM = 128  # if coop/vpt dimension doesnot match, project to vpt/coop
