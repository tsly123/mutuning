...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/scalebias.py'
    trainer_dst = trainer_dir+'/scalebias.py'
    shutil.copyfile(trainer_scr, trainer_dst)

    clip_model_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/clip/model_ss.py'
    clip_model_dst = trainer_dir + '/clip_model_ss.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_scalebias.py'
    cfg_dst = trainer_dir + '/train_scalebias.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline.PREC = prec  # fp16, fp32, amp
