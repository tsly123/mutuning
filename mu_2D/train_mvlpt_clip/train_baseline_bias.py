...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/baseline_bias.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_baseline_bias.py'
    cfg_dst = trainer_dir + '/train_baseline_bias.py'
    shutil.copyfile(cfg_scr, cfg_dst)
