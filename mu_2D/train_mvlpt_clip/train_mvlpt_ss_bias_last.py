...
import trainers.mvlpt_ss_bias_last
...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/mvlpt_ss_bias_last.py'
    trainer_dst = trainer_dir+'/mvlpt_ss_bias_last.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_mvlpt_ss_bias_last.py'
    cfg_dst = trainer_dir + '/train_mvlpt_ss_bias_last.py'
    shutil.copyfile(cfg_scr, cfg_dst)
