...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/frozen_viz.py'
    trainer_dst = trainer_dir+'/frozen_viz.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_frozen.py'
    cfg_dst = trainer_dir + '/train_frozen.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline_bias.PREC = "fp16"  # fp16, fp32, amp
