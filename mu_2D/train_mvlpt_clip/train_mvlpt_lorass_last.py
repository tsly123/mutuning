...
import trainers.mvlpt_lorass_last
...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/mvlpt_lorass_last.py'
    trainer_dst = trainer_dir+'/mvlpt_lorass_last.py'
    shutil.copyfile(trainer_scr, trainer_dst)

    clip_model_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/clip/model_lora.py'
    clip_model_dst = trainer_dir + '/clip_model_lora.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_mvlpt_lorass_last.py'
    cfg_dst = trainer_dir + '/train_mvlpt_lorass_last.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
if __name__ == "__main__":
    ...
    # directory path
    # parser.add_argument("--viz-attn", type=str, default="None", help="directory path, similar as args.eval_only")
