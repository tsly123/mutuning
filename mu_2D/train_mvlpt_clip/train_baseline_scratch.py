...
import trainers.baseline_scratch
...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/baseline_scratch.py'
    trainer_dst = trainer_dir+'/baseline_scratch.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_baseline_scratch.py'
    cfg_dst = trainer_dir + '/train_baseline_scratch.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Baseline_scratch = CN()
    cfg.TRAINER.Baseline_scratch.PREC = prec  # fp16, fp32, amp
    cfg.TRAINER.Baseline_scratch.PROJECT_METHOD = 'transformer'  # could be identity / mlp / transformer
    cfg.TRAINER.Baseline_scratch.PROJECT_DIM = 128  # if coop/vpt dimension doesnot match, project to vpt/coop
