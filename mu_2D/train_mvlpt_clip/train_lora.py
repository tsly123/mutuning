...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/lora.py'
    trainer_dst = trainer_dir+'/lora.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train_lora.py'
    cfg_dst = trainer_dir + '/train_lora.py'
    shutil.copyfile(cfg_scr, cfg_dst)
