...
def copy_files(cfg):
    ...
    trainer_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/trainers/mvlpt.py'
    trainer_dst = trainer_dir+'/mvlpt.py'
    ...
    cfg_scr = '/project/hnguyen2/stly/code/prompting/MVLPT_2D/train_mvlpt_clip/train.py'
    cfg_dst = trainer_dir + '/train.py'
    shutil.copyfile(cfg_scr, cfg_dst)
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--eval-only', default=False, type=boolean_string, help='evaluation only')
