...
class Camelyon17_wild(DatasetBase):

    dataset_name = "camelyon17_wild"

    def __init__(self, cfg):
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        self.dataset_dir = os.path.join(root, self.dataset_name)
        self.image_dir = os.path.join(self.dataset_dir, self.dataset_name+'_imgs')
...
# data_path = '/home/stly/Data/HULA/projects/dataset/medmnist'#/'+data_flag
