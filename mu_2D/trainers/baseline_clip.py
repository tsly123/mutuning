...
class Baseline_clip_trainer(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.Baseline_clip.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.Baseline_clip.PREC == "fp32" or cfg.TRAINER.Baseline_clip.PREC == "amp":
        ...
        for name, param in self.model.named_parameters():
            # print(name)
            # if "prompt_learner" in name or "image_encoder" not in name or "text_encoder" in name:
        ...
        self.register_model("baseline_clip_model", self.model, self.optim, self.sched)
        self.scaler = GradScaler() if cfg.TRAINER.Baseline_clip.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.Baseline_clip.PREC
        if prec == "amp":
            with autocast():
