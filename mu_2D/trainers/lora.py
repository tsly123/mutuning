...
def load_clip_to_cpu(cfg):
    ...
    model = clip.build_model(state_dict or model.state_dict(), ssmode='lora')
...
class Lora_trainer(TrainerX):
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.Baseline.PREC == "fp32" or cfg.TRAINER.MVLPT.PREC == "amp":
        ...
        self.register_model("model", self.model.image_encoder, self.optim, self.sched)
