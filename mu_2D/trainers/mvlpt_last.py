...
class CustomCLIP(nn.Module):
    ...
    def get_intermediate_layers(self, image):
        ...
        # image_features = self.image_encoder(image.type(self.dtype), vpt_emb, vpt_emb_deep)
        class_token, weights_all_blocks, weights_attnout_blocks = self.image_encoder.get_intermediate_layers(image.type(self.dtype), vpt_emb, vpt_emb_deep)
...
class MVLPT_last_trainer(TrainerX):
