...
class Baseline_clip_bias_trainer(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.Baseline_clip_bias.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.Baseline_clip_bias.PREC == "fp32" or cfg.TRAINER.Baseline_clip_bias.PREC == "amp":
        ...
        for name, param in self.model.named_parameters():
            # set requires_grad_(False) for all params
        ...
        self.register_model("baseline_clip_bias_model", self.model, self.optim, self.sched)
        self.scaler = GradScaler() if cfg.TRAINER.Baseline_clip_bias.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.Baseline_clip_bias.PREC
        if prec == "amp":
            with autocast():
