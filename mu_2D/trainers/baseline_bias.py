...
class Baseline_bias_trainer(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.Baseline_bias.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.Baseline_bias.PREC == "fp32" or cfg.TRAINER.Baseline_bias.PREC == "amp":
        ...
        if cfg.TRAINER.Baseline_bias.PREC == "fp16":
        ...
        for name, param in self.model.named_parameters():
            # set requires_grad_(True) for bias in image_encoder
            if ('image_encoder' in name and 'bias' in name) or ('image_encoder' in name and 'head' in name):
        ...
        self.register_model("Bias", self.model.image_encoder, self.optim, self.sched)
        self.scaler = GradScaler() if cfg.TRAINER.Baseline_bias.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.Baseline_bias.PREC
        if prec == "amp":
            with autocast():
